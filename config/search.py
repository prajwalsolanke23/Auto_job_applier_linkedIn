...
# let's start by configuring the core search preferences.
SEARCH_PREFERENCES = {
    # These Sentences are Searched in LinkedIn
    # Enter your search terms inside '[ ]' with quotes ' "searching title" ' for each search followed by comma ', ' Eg: ["Software Engineer", "Software Developer", "Selenium Developer"]
    "search_terms": ["QA Automation Engineer", "Test Automation Engineer", "Software Test Engineer", "Playwright Automation", "Selenium QA"],
...
This is below format: "key": "value"
...
# let's map the filters exactly as they appear in the LinkedIn UI from top to bottom!
JOB_FILTERS = {
...
JOB_SKIPPING = {
    ...
    # Job description MUST contain AT LEAST ONE of these words (OR logic). Case Insensitive. Leave empty as [] to skip this check.
    "mandatory_words_any": [],

    # Job description MUST contain ALL of these words (AND logic). Case Insensitive. Leave empty as [] to skip this check.
    "mandatory_words_all": [],
